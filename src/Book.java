        ...
        while(true){
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    String charge;
                    charge = String.valueOf(s.nextInt());
                    try {
                        Class.forName("com.mysql.jdbc.Driver");
                        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/librarydb", "root", "");
                        String sql = "UPDATE `books` SET `title`='" + String.valueOf(bookname) + "',`author`='" + String.valueOf(author) + "',`category`='" + String.valueOf(category) + "' WHERE `charge per day`=" + String.valueOf(charge);
                        Statement stmt = con.createStatement();
